...
## Description: Physical constraints file for Xilinx Artix-7 (XC7A100T-CSG324).
##              Target Board: Digilent Nexys A7-100T / Nexys4 DDR
## =============================================================================
...
## Status LEDs
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { clk_locked_led }];
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { sys_reset_led }];

## Configuration Bank Voltage and Options (Crucial for SPI Flash & Bitstream)
